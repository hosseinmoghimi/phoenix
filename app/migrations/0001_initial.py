# Generated by Django 3.1 on 2020-09-13 09:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('سایت', 'سایت'), ('سوالات', 'سوالات'), ('ویدیو', 'ویدیو'), ('درباره ما', 'درباره ما'), ('سربرگ ارتباط با ما', 'سربرگ ارتباط با ما'), ('لوگو', 'لوگو'), ('سربرگ مقاله', 'سربرگ مقاله'), ('سربرگ پروژه', 'سربرگ پروژه'), ('سربرگ پیش فرض برای صفحات', 'سربرگ پیش فرض برای صفحات'), ('سربرگ درباره ما', 'سربرگ درباره ما')], max_length=50, verbose_name='جای تصویر')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=50, verbose_name='key value')),
