...
urlpatterns = [
    ...
    path('ourworks/',views.PageView().ourworks,name='ourworks'),
    path('ourwork/<int:ourwork_id>/',views.PageView().ourwork,name='ourwork'),
    path('ourservice/<int:ourservice_id>/',views.PageView().ourservice,name='ourservice'),
    path('ourteam/<int:ourteam_id>/',views.BasicView().ourteam,name='ourteam'),
    path('resume/<int:ourteam_id>/',views.BasicView().resume,name='resume'),
